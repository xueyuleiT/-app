...
public class PieChartView extends DemoView {
	 ...
	 public PieChartView(Context context,HashMap<String,Integer> hashMap) {
		super(context);
		this.hashMap = hashMap;
		initView();
	 }	
	
	 public PieChartView(Context context, AttributeSet attrs,HashMap<String,Integer> hashMap){   
        super(context, attrs);   
        this.hashMap = hashMap;
        initView();
	 }
	 
	 public PieChartView(Context context, AttributeSet attrs, int defStyle,HashMap<String,Integer> hashMap) {
...
//			chart.hideGradient();
	...
	public void chartDataSet(HashMap<String, Integer> hashMap)
	{
		this.hashMap = hashMap;
		...
		while (iter.hasNext()) {
			...
			if(val != 0){
			//设置图表数据源				
			PieData pieData = new PieData(key,key+":"+val*100/Constant.conLst.size()+"%",val*100/Constant.conLst.size(),(int)Color.rgb(random.nextInt(256),
					random.nextInt(256), random.nextInt(256))) ;
			pecent += val*100/Constant.conLst.size();
			if(!flag){
		...
		if(pecent < 100){
			chartData.add(new PieData("其它:","其它"+(100-pecent)+"%",100-pecent,(int)Color.rgb(random.nextInt(256),
					random.nextInt(256), random.nextInt(256))));
		}
	}
	@Override
